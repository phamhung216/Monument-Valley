Shader "Custom/InterpolatedLightsAORotatedBlendColour" {
	Properties {
		...
		_BlendColor ("_BlendColor", Vector) = (1,0,0,1)
		_Blend ("_Blend", Float) = 1
		_InteractiveBlendColor ("_InteractiveBlendColor", Vector) = (1,1,1,1)
		_InteractiveBlend ("_InteractiveBlend", Float) = 0
	}
